...
const Stockprediction_oneday = () => {
  ...
  const generateLSTMPredictions = (historicalData) => {
    const lastPrice = historicalData[historicalData.length - 1].close;
    const predictions = [];
    let price = lastPrice;
    
    // Simulate volatility and trend
    const volatility = 0.02;
    const trend = -0.003; // Slight downward trend
  ...
  const generateMonteCarloSimulations = (lastPrice, numSimulations = 100) => {
    const simulations = [];
    const days = 10;
    ...
    reader.onload = (e) => {
      try {
        ...
        if (data.length > 0) {
          ...
          const lstmPredictions = generateLSTMPredictions(data);
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 text-white p-6">
      <div className="max-w-7xl mx-auto mt-16">
        ...
        {selectedTab === 'upload' && (
          <div className="bg-gray-800 rounded-xl p-12 shadow-xl text-center">
            ...
            <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
              ...
              The system will analyze the data and generate 10-day predictions using LSTM and Monte Carlo methods.
              Supports various CSV formats including quoted values and different date formats.
            </p>
          ...
          <>
            ...
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-6 mb-8 shadow-2xl">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div>
                  <p className="text-blue-100 text-sm mb-1">10-Day Prediction</p>
        ...
        {selectedTab === 'predictions' && predictions && (
          <>
            <div className="bg-gray-800 rounded-xl p-6 shadow-xl mb-6">
              <h2 className="text-2xl font-bold mb-4">LSTM 10-Day Price Predictions</h2>
                  ...
                  <tbody>
                    {predictions.map((pred) => (
                      <tr key={pred.day} className="border-b border-gray-700 hover:bg-gray-700">
                        ...
                        <td className="py-3 px-4 text-right">{pred.confidence}%</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
        ...
        {selectedTab === 'montecarlo' && csvData && (
          <div className="bg-gray-800 rounded-xl p-6 shadow-xl">
            ...
            <p className="text-gray-300 mb-6">Each line represents a possible price path over the next 10 days</p>
            <ResponsiveContainer width="100%" height={500}>
              <LineChart data={(() => {
                const simulations = generateMonteCarloSimulations(csvData[csvData.length - 1].close, 50);
                const chartData = [];
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="bg-gray-700 p-4 rounded-lg">
                ...
                <p className="text-2xl font-bold text-blue-400">${analysis?.predictedPrice.toFixed(2) || 'N/A'}</p>
              </div>
              <div className="bg-gray-700 p-4 rounded-lg">
...
export default Stockprediction_oneday;